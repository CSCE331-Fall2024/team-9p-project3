...
// This function handles the HTTP GET request, which is used for selecting the entire Inventory_items table from the database. 
export async function GET(req) {
    ...
    if (req.method === 'GET') {
        try {
            ...
            // Below database SQL command is selecting (or reading) the entire Inventory_items table.
